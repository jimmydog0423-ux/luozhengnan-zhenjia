...
worldCanvas.width=W/WORLD_SCALE;worldCanvas.height=H/WORLD_SCALE;
const worldCtx=worldCanvas.getContext("2d");
worldCtx.imageSmoothingEnabled=false;
function beginWorldLayer(){
  ctx=worldCtx;
  worldCtx.setTransform(1,0,0,1,0,0);
  worldCtx.clearRect(0,0,worldCanvas.width,worldCanvas.height);
  worldCtx.scale(1/WORLD_SCALE,1/WORLD_SCALE)
}
function endWorldLayer(){
  ctx=screenCtx;
  screenCtx.drawImage(worldCanvas,0,0,worldCanvas.width,worldCanvas.height,0,0,W,H)
}
...
function block3D(cx,cy,w,h,depth,color,opt={}){
  ...
  ctx.lineTo(cx+w/2+depth*.6,cy+h/2-depth);ctx.lineTo(cx+w/2,cy+h/2);
  ctx.closePath();ctx.fill();
  ctx.fillStyle=shade(color,.02);roundPath(cx-w/2,cy-h/2,w,h,r);ctx.fill();
  ctx.strokeStyle=shade(color,-.42);ctx.lineWidth=4.5;ctx.stroke();
...
function drawRoomArchitecture(room){
  ...
  // floor - a flat checker tile grid with grout lines, classic top-down RPG floor instead of gradient planks
  const TILE=50;
  for(let ty=120;ty<H;ty+=TILE)for(let tx=0;tx<W;tx+=TILE){
    const odd=((tx/TILE)+(ty/TILE))%2;
    ctx.fillStyle=odd?K.floor2:K.floor;ctx.fillRect(tx,ty,TILE,TILE);
    ctx.fillStyle="rgba(0,0,0,.22)";ctx.fillRect(tx,ty,TILE,3);ctx.fillRect(tx,ty,3,TILE)
  }
  // walls - flat color with horizontal plank seams, no gradient
  ctx.fillStyle="#2c2730";ctx.fillRect(0,0,W,140);
  for(let wy=0;wy<140;wy+=20){ctx.fillStyle="rgba(0,0,0,.18)";ctx.fillRect(0,wy,W,2)}
  ctx.fillStyle="#544b59";ctx.fillRect(0,132,W,4);ctx.fillStyle="#241f28";ctx.fillRect(0,136,W,4);
  // windows - flat two-tone pane, framed
  for(let x=120;x<1500;x+=280){
    ctx.fillStyle="#0c0d12";ctx.fillRect(x-4,34,168,80);
    ctx.fillStyle=(room==="auditorium"||room==="oldhall")?"#4c1d27":"#334454";
    ctx.fillRect(x+8,46,144,56);
    ctx.fillStyle=(room==="auditorium"||room==="oldhall")?"#6e2c37":"#496485";
    ctx.fillRect(x+8,46,144,26);
    ctx.strokeStyle="#6b6070";ctx.lineWidth=6.4;ctx.strokeRect(x,38,160,72);
  ...
  if(room==="computer"){
    for(let i=0;i<4;i++){
      ...
      ctx.strokeStyle=K.cyan;ctx.lineWidth=4.8;roundPath(x+40,260,160,90,6);ctx.stroke();
  ...
  if(room==="basement"){
    for(let i=0;i<8;i++){
      ctx.strokeStyle=i%2?K.red:"#4c4048";ctx.lineWidth=25.6;ctx.globalAlpha=.85;
...
function drawDoors(){
  for(const d of roomDoors()){
    ...
    ctx.strokeStyle="#7a5560";ctx.lineWidth=6.4;ctx.stroke();
...
function drawOutdoorArchitecture(room){
  ...
  ctx.strokeStyle="rgba(0,0,0,.28)";ctx.lineWidth=6.4;
  ...
  if(room==="gate"){
    ...
    for(let x=10;x<W;x+=44){ctx.fillStyle="#100c10";ctx.fillRect(x,150,6,50);ctx.beginPath();ctx.moveTo(x+3,150);ctx.lineTo(x+3,140);ctx.strokeStyle="#100c10";ctx.lineWidth=6.4;ctx.stroke()}
    ...
    if(gd){
      ...
      ctx.strokeStyle="#20181c";ctx.lineWidth=19.2;ctx.strokeRect(0,-150,14,150);
      for(let i=0;i<6;i++){ctx.beginPath();ctx.moveTo(2,-150+i*25);ctx.lineTo(12,-150+i*25);ctx.stroke()}
      ctx.restore();
      ctx.save();ctx.translate(gx+70,gy+70);ctx.rotate(.5);
      ctx.strokeStyle="#20181c";ctx.lineWidth=19.2;ctx.strokeRect(-14,-150,14,150);
...
function drawProp(p,near){
  ...
  if(["photo","notice","poster","score","roll","wish","tape"].includes(id)){
    ...
    ctx.strokeStyle="#8a7c74";ctx.lineWidth=4.5;ctx.stroke();
    ...
    ctx.strokeStyle="rgba(0,0,0,.35)";ctx.lineWidth=6.4;
    ...
    ctx.strokeStyle="#1c161a";ctx.lineWidth=16.0;ctx.strokeRect(0,0,52,10);
    ctx.restore();
    ...
    ctx.strokeStyle="#2a2226";ctx.lineWidth=6.4;roundPath(-w*.22,-h*.1,w*.44,h*.24,3);ctx.stroke()
  }
  else if(id==="tree"){
    ...
    ctx.strokeStyle="#7c8c94";ctx.lineWidth=6.4;ctx.stroke();
    ...
    ctx.strokeStyle=K.cyan;ctx.lineWidth=5.1;roundPath(-46,-18,92,50,4);ctx.stroke();
    ...
    ctx.strokeStyle="#8c8578";ctx.lineWidth=6.4;ctx.beginPath();ctx.moveTo(0,-25);ctx.lineTo(14,-52);ctx.stroke()
  }
    ...
    ctx.strokeStyle=K.gold;ctx.lineWidth=6.4;ctx.beginPath();ctx.moveTo(0,20);ctx.lineTo(Math.sin(G.time*3)*10,-24);ctx.stroke()
  }
  else if(id==="shelf"){
  ...
  else if(id==="ball"){orb3D(0,0,26,"#c9793f");ctx.strokeStyle="#5a3418";ctx.lineWidth=4.8;ctx.beginPath();ctx.arc(0,0,26,0,Math.PI*2);ctx.stroke();ctx.beginPath();ctx.moveTo(-26,0);ctx.lineTo(26,0);ctx.moveTo(0,-26);ctx.lineTo(0,26);ctx.stroke()}
  else if(id==="curtain"){
    ...
    ctx.strokeStyle=K.red;ctx.lineWidth=22.4;ctx.beginPath();ctx.moveTo(-160,0);ctx.bezierCurveTo(-60,-30,60,30,160,0);ctx.stroke();
    ctx.strokeStyle="#2a1418";ctx.lineWidth=6.4;ctx.beginPath();ctx.moveTo(-160,0);ctx.bezierCurveTo(-60,-30,60,30,160,0);ctx.stroke()
  }
    ...
    ctx.strokeStyle="#8f8983";ctx.lineWidth=4.5;ctx.stroke();
    ...
    ctx.strokeStyle=K.gold;ctx.lineWidth=6.4;ctx.stroke();
    ctx.strokeStyle=K.gold;ctx.lineWidth=8.0;ctx.beginPath();ctx.moveTo(0,0);ctx.lineTo(0,-15);ctx.stroke();
...
function ringPulse(x,y){ctx.save();ctx.strokeStyle=K.gold;ctx.lineWidth=6.4;ctx.beginPath();ctx.arc(x,y,38+Math.sin(G.time*5)*4,0,Math.PI*2);ctx.stroke();ctx.restore()}
...
function drawCharacter(x,y,kind){
  ...
  // body: flat fill + a darker shadow-side strip reads as pixel-art 2-tone shading
  ctx.fillStyle=coat;roundPath(-16,-24,32,44,3);ctx.fill();
  ctx.fillStyle=shade(coat,-.28);ctx.fillRect(4,-24,12,44);
  ctx.strokeStyle=shade(coat,-.4);ctx.lineWidth=3.2;ctx.strokeRect(-16,-24,32,44);
  // head - flat skin tone, one shaded cheek
  ctx.fillStyle=K.skin;roundPath(-11,-44,22,20,3);ctx.fill();
  ctx.fillStyle=shade(K.skin,-.18);ctx.fillRect(4,-44,7,20);
  ctx.fillStyle=K.black;ctx.fillRect(-13,-50,26,10);
  ctx.fillStyle=accent;ctx.fillRect(kind.startsWith("fake")?-7:4,-38,5,5);
  ctx.restore()
}
function drawHUD(){
...
function drawPortrait(kind,x,y,flip=false,active=true){
  ...
  // coat: flat fill + a darker shadow-side band instead of a smooth gradient
  ctx.fillStyle=coat;roundPath(-125,-30,250,300,4);ctx.fill();
  ctx.fillStyle=shade(coat,-.26);ctx.fillRect(60,-30,65,300);
  ctx.fillStyle="#e0d8d0";ctx.fillRect(-42,-20,84,255);
  ctx.fillStyle=K.skin;ctx.fillRect(-42,-108,84,82);roundPath(-100,-265,200,165,6);ctx.fill();
  ctx.fillStyle=shade(K.skin,-.16);ctx.fillRect(60,-265,40,165);
  ctx.fillStyle=K.black;roundPath(-105,-285,210,56,4);ctx.fill();ctx.fillRect(-100,-250,40,60);ctx.fillRect(60,-250,40,60);
  ...
  if(kind==="overload"){
    ctx.fillStyle="#b75b68";roundPath(-80,-82,160,34,4);ctx.fill();ctx.fillStyle="#23151a";roundPath(-28,-152,56,12,3);ctx.fill()
  }
  ctx.restore()
}
